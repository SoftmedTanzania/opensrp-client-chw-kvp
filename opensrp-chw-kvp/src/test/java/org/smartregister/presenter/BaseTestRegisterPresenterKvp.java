...
@PrepareForTest(BaseKvpRegisterPresenter.class)
public class BaseTestRegisterPresenterKvp {
    @Mock
    protected BaseKvpRegisterPresenter baseKvpRegisterPresenter;

    @Mock
    protected KvpRegisterContract.Interactor interactor;
    @Mock
    protected KvpRegisterContract.Model model;
    @Mock
    protected KvpRegisterContract.View baseView;
    private BaseKvpRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseKvpRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseKvpRegisterPresenter, "getView"));
    }
