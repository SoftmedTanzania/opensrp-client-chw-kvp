...
@PrepareForTest(BaseKvpCallDialogFragment.class)
public class BaseTestCallDialogFragmentKvp {
    @Spy
    public BaseKvpCallDialogFragment baseKvpCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseKvpCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Whitebox.invokeMethod(baseKvpCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
    ...
    public void setCallTitle() throws Exception {
        ...
        Whitebox.invokeMethod(baseKvpCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
        Assert.assertEquals("message Kvp Client", textView.getText());
    }

    @Test(expected = Exception.class)
    public void initUI() throws Exception {
        Mockito.when(memberObject.getPhoneNumber()).thenReturn("123456789");
        Whitebox.invokeMethod(baseKvpCallDialogFragment, "initUI", viewGroup);
        PowerMockito.verifyPrivate(baseKvpCallDialogFragment).invoke("setCallTitle", viewGroup, view.getId(), "message");
