...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_KVP_TEST = "date_chw_kvp_test";
        public static final String FEVER_KVP_CHW = "fever_kvp_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String KVP_RESULTS = "kvp_results";
        public static final String DATE_HF_KVP_TEST = "date_hf_kvp_test";
        public static final String KVP_TEST_DATE = "kvp_test_date";
        public static final String KVP_TREAT = "kvp_treat";
        ...
        public static final String KVP_EDU_CHW = "kvp_edu_chw";
        ...
        public static final String PHONE_NUMBER_KVP = "phoneNumberKvp";
