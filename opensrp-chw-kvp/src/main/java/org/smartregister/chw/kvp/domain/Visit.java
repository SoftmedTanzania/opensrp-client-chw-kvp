...
public class Visit {
    ...
    private Map<String, List<org.smartregister.chw.kvp.domain.VisitDetail>> visitDetails = new HashMap<>();
    ...
    public Map<String, List<org.smartregister.chw.kvp.domain.VisitDetail>> getVisitDetails() {
        return visitDetails;
    }

    public void setVisitDetails(Map<String, List<org.smartregister.chw.kvp.domain.VisitDetail>> visitDetails) {
