...
import org.smartregister.chw.kvp.fragment.BaseKvpVisitFragment;
 ...
 */
public class BaseKvpVisitAction {
    ...
    private BaseKvpVisitFragment destinationFragment;
    private String formName;
    private String jsonPayload;
    private String selectedOption;
    private KvpVisitActionHelper kvpVisitActionHelper;
    private Map<String, List<VisitDetail>> details;
    private Context context;
    private Validator validator;

    private BaseKvpVisitAction(Builder builder) throws ValidationException {
        ...
        this.kvpVisitActionHelper = builder.kvpVisitActionHelper;
        ...
        try {
            if (StringUtils.isBlank(jsonPayload) && StringUtils.isNotBlank(formName)) {
                ...
                if (details != null && details.size() > 0) {
                    KvpJsonFormUtils.populateForm(jsonObject, details);
                }

                jsonPayload = jsonObject.toString();
            }

            if (kvpVisitActionHelper != null) {
                kvpVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = kvpVisitActionHelper.getPreProcessed();
                ...
                String sub_title = kvpVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = kvpVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        kvpVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = kvpVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = kvpVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = kvpVisitActionHelper.postProcess(jsonPayload);
        }

        kvpVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public BaseKvpVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseKvpVisitFragment destinationFragment) {
    ...
    public KvpVisitActionHelper getKvpVisitActionHelper() {
        return kvpVisitActionHelper;
    }

    public void setKvpVisitActionHelper(KvpVisitActionHelper kvpVisitActionHelper) {
        this.kvpVisitActionHelper = kvpVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getKvpVisitActionHelper() != null) {
            setActionStatus(getKvpVisitActionHelper().evaluateStatusOnPayload());
        }
    }

    public org.smartregister.chw.kvp.model.BaseKvpVisitAction.Status computedStatus() {
    ...
    public interface KvpVisitActionHelper {
         ...
         */
        void onPayloadReceived(org.smartregister.chw.kvp.model.BaseKvpVisitAction kvpVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseKvpVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public Builder withHelper(KvpVisitActionHelper kvpVisitActionHelper) {
            this.kvpVisitActionHelper = kvpVisitActionHelper;
            return this;
        }
        ...
        public org.smartregister.chw.kvp.model.BaseKvpVisitAction build() throws ValidationException {
            return new org.smartregister.chw.kvp.model.BaseKvpVisitAction(this);
        }
    }
