...
import org.smartregister.chw.kvp.util.ConfigHelper;
...
public class BaseKvpRegisterFragmentModel implements KvpRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(KvpLibrary.getInstance().context().applicationContext());
    }
