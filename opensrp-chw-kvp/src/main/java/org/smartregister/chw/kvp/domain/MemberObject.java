...
public class MemberObject implements Serializable {
    ...
    private String feverKvpChw;
    private String feverDuration;
    private String dateHfKvpTest;
    private Date kvpTestDate;
    private String kvpTreat;
    private String famLlin;
    private String llin2Days;
    private String llinCondition;
    private String kvpEduChw;
    ...
    private String kvpFollowUpDate;
    ...
    public String getDateChwKvpTest() {
        return dateChwKvpTest;
    }

    public void setDateChwKvpTest(String dateChwKvpTest) {
        this.dateChwKvpTest = dateChwKvpTest;
    }

    public String getFeverKvpChw() {
        return feverKvpChw;
    }

    public void setFeverKvpChw(String feverKvpChw) {
        this.feverKvpChw = feverKvpChw;
    }
    ...
    public String getDateHfKvpTest() {
        return dateHfKvpTest;
    }

    public void setDateHfKvpTest(String dateHfKvpTest) {
        this.dateHfKvpTest = dateHfKvpTest;
    }

    public Date getKvpTestDate() {
        return kvpTestDate;
    }

    public void setKvpTestDate(Date kvpTestDate) {
        this.kvpTestDate = kvpTestDate;
    }

    public String getKvpTreat() {
        return kvpTreat;
    }

    public void setKvpTreat(String kvpTreat) {
        this.kvpTreat = kvpTreat;
    }
    ...
    public String getKvpEduChw() {
        return kvpEduChw;
    }

    public void setKvpEduChw(String kvpEduChw) {
        this.kvpEduChw = kvpEduChw;
    }
    ...
    public String getKvpFollowUpDate() {
        return kvpFollowUpDate;
    }

    public void setKvpFollowUpDate(String kvpFollowUpDate) {
        this.kvpFollowUpDate = kvpFollowUpDate;
    }
}
